...
\newcommand{\utcnlogo}{\includegraphics[width=14.5cm]{sigla.jpg}}
...
\begin{enumerate}
 ...
 \item \textbf{Data emiterii temei:} \textit{Exemplu:} noiembrie 2025

 \item \textbf{Data predării:} \textit{Exemplu:} 5 iulie 2026
\end{enumerate}
...
examenului de finalizare a studiilor de disertație la Facultatea de Automatică și Calculatoare, Programul de studii 
\dots \dots \dots \dots \dots \dots \dots \dots \dots \dots \dots, din cadrul Universității 
Tehnice din Cluj-Napoca, sesiunea \dots \dots (iulie/septembrie) \dots \dots a anului universitar 2025-2026, declar pe
